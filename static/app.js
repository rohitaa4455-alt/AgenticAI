...
Projects: Flask + SQLite inventory API (JWT); BeautifulSoup campus scraper.`;
  ...
  async onSubmit(e) {
    ...
    this.els.submit.innerHTML = '<span class="btn__spinner"></span> <span class="btn__text">Running Assessment...</span>';
    ...
    try {
      ...
      if (window.innerWidth <= 768) {
        setTimeout(() => this.els.tracker.classList.add("is-collapsed"), 1000);
      }
    } catch (err) {
      ...
      this.els.submit.innerHTML = '<span class="btn__icon">▶</span> <span class="btn__text">Run Assessment</span>';
    }
  }
